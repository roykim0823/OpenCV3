...
int main( int argc, char** argv ) {
  ...
  cv::namedWindow( "Example 2-5-out_1stBlurred", cv::WINDOW_AUTOSIZE );
  cv::namedWindow( "Example 2-5-out_2ndBlurred", cv::WINDOW_AUTOSIZE );
  ...
  cv::imshow( "Example 2-5-out_1stBlurred", out );
  cv::GaussianBlur( out, out, cv::Size(5,5), 3, 3);
  cv::imshow( "Example 2-5-out_2ndBlurred", out );
